...
const ItemTemplate = React.memo((props: ItemTemplateProps) => {
  ...
  const getClassName: () => string = useCallback(() => {
    ...
    return `whitespace-nowrap w-1/2 md:w-1/3 lg:w-auto transition-all duration-300 hover:bg-gray-100 dark:hover:bg-primary-light p-2 rounded cursor-pointer ${textColor} ${textColorHover}`;
  }, [primaryColor]);
